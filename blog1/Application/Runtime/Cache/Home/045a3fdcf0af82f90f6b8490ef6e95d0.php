...
<a href="<?php echo U('Index/allxz');?>">一键下载</a>
</div>
...
<img src="/blog1/Public/loading.gif" data-original="<?php echo ($v["imgurl"]); ?>" class="tutu" />
...
<script type="text/javascript">
     function fun(page){
        ...
        ajax.open('get',"<?php echo U('Index/con');?>?page="+page);
        ajax.send();
    }
...
<SCRIPT src="/blog1/Public/Home/js/jquery-1.7.2.js" type=text/javascript></SCRIPT>  
<SCRIPT src="/blog1/Public/Home/js/jquery.lazyload.min.js" type=text/javascript></SCRIPT>  
  
<script type="text/javascript" charset="utf-8">  
      $(function() {  
          $("img").lazyload({   
          placeholder : "/blog1/Public/loading.gif",  
                 effect: "fadeIn"  
           });    
      });  

...
<body>
<div class="g"><img src="/Public/Home/xc/g.png"></div>
	<div class="banner">
	
	</div>
    <div class="jay"><img src="/Public/Home/xc/jay.png"></div>
	<div class="left"></div>
	<div class="right"></div>
	<div class="load">
		<span><img src="/Public/Home/xc/loading.gif"></span>
	</div>
	<div class="container">
		<ul class="content">
			<li>
...
<!-- <div align="center" style="clear:both;font-size:12px;color:#666;" id="foot_bm"><a href="http://www.5icool.org/a/201604/1267.html" target="_blank"><strong>酷炫的jquery拼图相册</strong>   [源码下载][使用帮助]</a></div> -->
<!--  -->

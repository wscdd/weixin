...
<link href="/Public/Home/css/animation.css" rel="stylesheet"><!-- 没有此文件 -->
<!-- 返回顶部调用 begin -->
...
<header>
  ...
  <nav id="nav">
    <ul>
      <li><a href="/" >网站首页</a></li>
      <?php if(is_array($cate_list)): foreach($cate_list as $key=>$cate_list): ?><li><a href="<?php echo U('Index/list_type');?>?id=<?php echo ($cate_list["cate_id"]); ?>" target="" title="<?php echo ($cate_list["cate_name"]); ?>"><?php echo ($cate_list["cate_name"]); ?></a></li><?php endforeach; endif; ?>
    ...
    <!--   <div class="toppic">
      ...
      <div class="clicks">
       ...
       <div class="tuijian">
        <h2>热门文章</h2>
        <ol>
          <?php if(is_array($hot_data)): foreach($hot_data as $key=>$hv): ?><li><span><strong><?php echo ($i++); ?></strong></span><a href="<?php echo U('Index/details');?>?id=<?php echo ($hv["art_id"]); ?>"><?php echo ($hv["title"]); ?></a></li><?php endforeach; endif; ?>
        </ol>
      </div>
      <div class="search">
